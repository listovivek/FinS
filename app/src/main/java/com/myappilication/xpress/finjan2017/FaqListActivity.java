...
public class FaqListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.faqlist);
        sharedpreferences = getSharedPreferences(SharedPrefUtils.MyPREFERENCES, Context.MODE_PRIVATE);
        editor = sharedpreferences.edit();

        mOfflineDatabaseHelper = new OfflineDatabaseHelper(FaqListActivity.this);
      ...
      //  pb.setVisibility(View.VISIBLE);
       ...
       searchviewfaq.setFocusable(false);
        ...
        searchviewfaq.setQuery(sharedpreferences.getString("Search_query",""), false);
    ...
    private void getSearchData() {
       // Search_query="";
        ...
        RxClient.get(context).getSearchFieldsForQus(sharedpreferences.getString(SharedPrefUtils.SpRememberToken, ""),
                new faqfulllistreq(Search_query), new Callback<faqfulllistresp>() {
                    @Override
