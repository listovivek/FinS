...
public  class FaqListAdapter extends RecyclerView.Adapter<FaqListAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            tv_question = (TextView) view.findViewById(R.id.textfaqlist_question);
            tv_answer = (TextView) view.findViewById(R.id.textfaqlist_answer);
    ...
    public FaqListAdapter(List<Faqlistdatas> Listdata) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.faqlist_cardview, parent, false);
